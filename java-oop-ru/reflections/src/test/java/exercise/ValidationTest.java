...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        System.out.println(notValidFields); // =>  {country=[length less than 4], street=[cannot be null]}
        ...
        System.out.println(notValidFields2); // =>  {country=[length less than 4], city=[cannot be null], street=[cannot be null]}

        Address address3 = new Address("USA", "Texas", "Main St.", "7", "2");
